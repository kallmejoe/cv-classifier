...
def tune_hyperparameters(
    ...
    svm_grid = GridSearchCV(
        ...
        {"C": config.svm_c_values, "max_iter": [config.svm_max_iter]},
        cv=config.cv_folds,
        scoring="accuracy",
        n_jobs=-1,
        verbose=0,
    ...
    lr_grid = GridSearchCV(
        ...
        {"C": config.lr_c_values, "max_iter": [config.lr_max_iter]},
        cv=config.cv_folds,
        scoring="accuracy",
        n_jobs=-1,
        verbose=0,
...
class ResumePredictor:
    ...
    def predict_batch(self, resume_texts: List[str]) -> List[HierarchicalPrediction]:
        """
