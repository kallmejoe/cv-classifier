...
class TestConfidenceCalculation:
    ...
    def test_soft_voting_confidence(self):
        ...
        # Weighted average
        weighted_sum = (
            weights[0] * clf1_probs + 
            weights[1] * clf2_probs + 
            weights[2] * clf3_probs
        )
...
class TestDataLoader:
    ...
    def test_dataset_config_defaults(self):
        ...
        from importer import DatasetConfig
...
class TestIntegration:
    ...
    def test_predictor_returns_valid_confidence(self, model_exists):
        ...
        assert abs(result['confidence'] - result['top_5_predictions'][0]['probability']) < 0.001
